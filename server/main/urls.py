...
bike_nested_router.register(r'request', BikeAccessView, base_name='bike-access-request')
bike_nested_router.register(r'summary', BikeAccessView, base_name='bike-summary')
bike_nested_router.register(r'status', BikeAccessView, base_name='bike-status')
